...
\documentclass{article} \input{resume-style} \title{Curriculum
  Vit\ae{}} \author{T. V. Raman}
\begin{document}
%\thispagestyle{fancy}
...
\multicolumn{2}{c}{Google Research}\newrow
(650) 253-2853 \textit{(Work)} &
(650) 799-5724 \textit{(Home)}\newrow
\href{mailto:tv.raman.tv@gmail.com}{\email{tv.raman.tv@gmail.com}}  &
\href{http://emacspeak.sf.net/raman}{emacspeak.sf.net/raman}\newrow
\end{tabular}
\end{center}
...
industry experience in advanced technology development.  During
this time, I have authored $3$~books and filed over $50$~patents;
my work on auditory interfaces was profiled in the September~1996
issue of Scientific American.  I have leading edge expertise in
Web standards, auditory interfaces and scripting languages. I
participate in numerous W3C~working groups and authored Aural CSS
(ACSS); in 1996 I wrote the first ACSS implementation.  I have
led the definition of XML specifications for
the next generation WWW including XForms, XML Events, and
Compound Document Formats such as X$+$V.
...
natural dimension in user interfaces, and I am developing
application frameworks  that combine speech technologies with the power of the
Web to deliver innovative multimodal solutions that are
...
\section*{Books,\ Patents And Software}
...
\bibitem{raman:aui97} T.~V. Raman.  \newblock {\em Auditory User
    Interfaces ---Toward The Speaking Computer}.
...
\bibitem{raman:ip-intel93} T.\ V.\ Raman and Jim~A. Larson.
...
\bibitem{raman:sciam97} T.~V. Raman.  \newblock Netsurfing
  without a monitor.  \newblock {\em Scientific American}, March
  1997.
...
\bibitem{2001:w3c-xhtml-voice} T.~V.  Raman et al.  \newblock
  ...
  December, 2001.  \livelink{http://www.w3.org/tr/xhtml+voice}
