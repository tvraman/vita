...
this time, I have authored $3$~books and filed over $100$~patents; my
...
Deliver technologies that enable ubiquitous, eyes-free access to the
cloud from a wide variety of devices including smart phones, smart
speakers and wearables. Speech is the next dimension in user
interfaces, and I am developing application frameworks that combine
speech technologies with the power of the Cloud to deliver user-aware
interfaces that enable anytime, anywhere access to one's personal
assistant.
